...
/** Load a CycloneDX SBOM file into the open atom and run enrichment passes (CdxPass,
  * EasyTagsPass) so that dependency data (PURLs, framework tags) is available for reachability
  * analysis.
  */
